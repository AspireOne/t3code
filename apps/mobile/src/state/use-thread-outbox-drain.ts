...
export async function completeQueuedMessageDelivery(
  ...
  try {
    ...
    // Server-queued messages live in the composer queue until their turn starts;
    // they may be removed without ever being echoed as a chat message.
    if (queuedMessage.deliveryMode !== "queue") {
